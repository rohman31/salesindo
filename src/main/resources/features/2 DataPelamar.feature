Feature: Customer Input Data Pelamar
	Scenario: Testing Input Data Pelamar 
	...
	Scenario: Testing module Alamat Tinggal Pelamar Sekarang
		When Customer input form alamat tinggal sekarang
		Then Customer berhasil input form alamat tinggal sekarang
		
		Scenario: Testing Data Informasi Saudara Tidak Serumah 
